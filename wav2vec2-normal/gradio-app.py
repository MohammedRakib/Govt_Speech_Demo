...
# from punctuate.punctuate import punctuator
import time
import librosa
...
def transcribe(microphone, file_upload):
    ...
    # start_time = time.time()
    # print("Starting to Punctuate")
    # punctuated_text = punctuator(text)
    # print(f"\n Punctuation COMPLETED in {round(time.time()-start_time, 2)}s \n")

    return warn_output + text
    # return warn_output + punctuated_text
...
def yt_transcribe(yt_url):
    ...
    # return html_embed_str, punctuated_text
